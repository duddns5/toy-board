...
public class JDBCTemplate {
	...
	// 생성자를 private으로 처리해 외부에서 JDBCTemplate를 생성하는 것을 차단
	...
	// Static 메서드를 사용해 타입으로도 사용가능하게 만든다.
	public static JDBCTemplate getInstance() {
		// 한번도 instance 변수가 초기화 된적이 없다면(한번도 생성이 된적이 없다면)
		if (instance == null) {
			instance = new JDBCTemplate();
		}
		// 아니면 기존에 생성해놓았던 instance를 반환한다.
		return instance;
